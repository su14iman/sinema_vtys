        ...
        <form method="post" class="sign-in-form card" style="margin-top: 18%;" id="loginForm">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="inputUsername" name="sales_person_email" class="form-control" placeholder="Email address" required="">
                </div>
                <div class="form-group">
                    <label for="inputPassword" class="sr-only">Password</label>
                    <input type="password" name="sales_person_password" id="inputPassword" class="form-control" placeholder="Password" required="">
                </div>
