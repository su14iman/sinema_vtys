...
include("../php/salesClass.php");
  ...
  if(isset($_POST['submit'])){
    $data = new \stdClass;
    $data->sales_person_name = $_POST['sales_person_name'];
    $data->sales_person_surname = $_POST['sales_person_surname'];
    $data->sales_person_phone = $_POST['sales_person_phone'];
    $data->sales_person_email = $_POST['sales_person_email'];
    $data->sales_person_password = $_POST['sales_person_password'];
    if($salesClass->signup($data)){
...
<div class="container-fluid mt-5 m-5">
    ...
    <div class="form-group row justify-content-center r">
        ...
        <input type="text" class="form-control" id="i-name" name="sales_person_name" required>
        </div>
    </div>
    <div class="form-group row justify-content-center r">
        <label for="i-lastname" class="col-lg-4 col-sm-12 col-12 col-form-label text-center">Surname</label>
        <div class="col-lg-8 col-md-8 col-sm-8 col-12">
        <input type="text" class="form-control" id="i-lastname" name="sales_person_surname" required>
        </div>
    </div>
    <div class="form-group row justify-content-center r">
        <label for="i-tel" class="col-lg-4 col-sm-12 col-12 col-form-label text-center">Phone</label>
        <div class="col-lg-8 col-md-8 col-sm-8 col-12">
        <input type="tel" class="form-control" id="i-tel" name="sales_person_phone" required>
        </div>
    </div>
    <div class="form-group row justify-content-center r">
        <label for="i-email" class="col-lg-4 col-sm-12 col-12 col-form-label text-center">Email</label>
        <div class="col-lg-8 col-md-8 col-sm-8 col-12">
        <input type="email" class="form-control" id="i-email" name="sales_person_email" required>
        </div>
    </div>
    <div class="form-group row justify-content-center r">
        <label for="input-password" class="col-lg-4 col-sm-12 col-12 col-form-label text-center">Password</label>
        <div class="col-lg-8 col-md-8 col-sm-8 col-12">
        <input type="password" class="form-control" id="i-password" name="sales_person_password" required>
        </div>
    </div>
